...
| Novel follow and bookmarks | Partial | pixez-flutter exposes novel follow, public/private novel bookmarks, novel ranking, novel watchlist, and series pages as one novel workflow. | KeiPix has novel recommended, latest, ranking, search, series, watchlist, bookmark actions, series chapter sheets, and related navigation, but novel bookmark tag suggestions still need first-class wiring. | Continue unifying novel surfaces with compact iPhone menus and fuller iPad landscape/macOS panes. |
