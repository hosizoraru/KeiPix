...
struct NativeBoundaryTests {
    ...
    func macOSLaunchSizingClampsRestoredNarrowWindows() throws {
        ...
        #expect(sidebarView.contains("static let macOS = SidebarColumnWidth(min: 252, ideal: 286, max: 336)"))
        #expect(sidebarView.contains("static let iPadOS = SidebarColumnWidth(min: 214, ideal: 238, max: 284)"))
