...
struct NativeBoundaryTests {
    ...
    func macOSLaunchSizingClampsRestoredNarrowWindows() throws {
        ...
        #expect(sidebarView.contains("static let macOS = SidebarColumnWidth(ideal: 286)"))
        #expect(sidebarView.contains("static let iPadOS = SidebarColumnWidth(ideal: 238)"))
        ...
        #expect(sidebarView.contains(".navigationSplitViewColumnWidth(columnWidth.ideal)"))
