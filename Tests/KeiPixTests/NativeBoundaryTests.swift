...
struct NativeBoundaryTests {
    ...
    func compactSearchIsOptInInsteadOfPersistentEverywhere() throws {
        ...
        #expect(tabBarBridge.contains("tabBarController.view.addSubview(pillView)"))
        #expect(tabBarBridge.contains("tabBarController.view.addSubview(panelView)"))
        #expect(tabBarBridge.contains("tabBarController.view.bringSubviewToFront(pillView)"))
        #expect(tabBarBridge.contains("tabBarController.view.bringSubviewToFront(panelView)"))
