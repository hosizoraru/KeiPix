...
struct NativeBoundaryTests {
    ...
    func iPadFeedRootDispatchesNonArtworkRoutes() throws {
        ...
        #expect(contentView.contains("allowsMasonryLayout: showsSidebarToggle"))
    ...
    func compactSearchIsOptInInsteadOfPersistentEverywhere() throws {
        ...
        #expect(iPadContentView.contains("selectedTab = .mobile(.illustrations)"))
    ...
    func galleryFeedLayoutsUseNativeCollectionBridge() throws {
        ...
        #expect(galleryView.contains("let allowsMasonryLayout: Bool"))
        #expect(galleryView.contains("allowsMasonryLayout: Bool = true"))
        #expect(galleryView.contains("private var effectiveGalleryLayoutMode: GalleryLayoutMode"))
        #expect(galleryView.contains("return .compactGrid"))
