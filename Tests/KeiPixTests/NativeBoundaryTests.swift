...
struct NativeBoundaryTests {
    ...
    func iPadFeedRootDispatchesNonArtworkRoutes() throws {
        ...
        #expect(nativeToolbarMenu.contains("UIColor.systemRed.resolvedColor(with: traitCollection).setFill()"))
    ...
    func compactSearchIsOptInInsteadOfPersistentEverywhere() throws {
        ...
        #expect(nativeToolbarMenuButton.contains("UIColor.systemRed.resolvedColor(with: traitCollection).setFill()"))
