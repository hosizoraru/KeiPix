...
struct NativeBoundaryTests {
    ...
    func pixivActivityFeedUsesNativeListOrMasonryAndVisibleRoute() throws {
        ...
        #expect(iPadContentView.contains(".submenu("))
        #expect(iPadContentView.contains("title: L10n.pixivActivityFeedScope"))
        #expect(iPadContentView.contains("subtitle: store.pixivActivityFeedScope.title"))
        #expect(iPadContentView.contains("title: L10n.pixivActivityKindFilter"))
        #expect(iPadContentView.contains("subtitle: store.pixivActivityKindFilter.title"))
        #expect(iPadContentView.contains("PixivActivityKindFilter.allCases"))
        #expect(iPadContentView.contains("presentation: .singleSelection"))
        ...
        #expect(iPadContentView.contains("IPadToolbarMenuAction.pixivActivityKind(filter)"))
