...
struct NativeBoundaryTests {
    ...
    func iPadFeedRootDispatchesNonArtworkRoutes() throws {
        ...
        #expect(contentView.contains("subtitle: store.galleryLayoutMode.title"))
        #expect(contentView.contains("paletteTitle: L10n.quickOpenLink"))
        #expect(contentView.contains("paletteTitle: L10n.quickPixivID"))
        #expect(contentView.contains("paletteTitle: L10n.quickImageSearch"))
        ...
        #expect(nativeToolbarMenu.contains("menu.preferredElementSize = .large"))
        #expect(nativeToolbarMenu.contains("paletteTitle: String? = nil"))
        #expect(nativeToolbarMenu.contains("enum PresentationStyle"))
        #expect(nativeToolbarMenu.contains("case popover"))
        #expect(nativeToolbarMenu.contains("button.showsMenuAsPrimaryAction = false"))
        #expect(nativeToolbarMenu.contains("button.menu = nil"))
        #expect(nativeToolbarMenu.contains("NativeToolbarMenuPopoverController"))
        #expect(nativeToolbarMenu.contains("NativeToolbarMenuQuickActionControl"))
        #expect(nativeToolbarMenu.contains("titleLabel.text = action.paletteTitle ?? action.title"))
        #expect(nativeToolbarMenu.contains("stack.axis = .vertical"))
        #expect(nativeToolbarMenu.contains("heightAnchor.constraint(greaterThanOrEqualToConstant: 84)"))
