...
struct NativeBoundaryTests {
    ...
    func compactSearchIsOptInInsteadOfPersistentEverywhere() throws {
        ...
        #expect(iPadContentView.contains("PhoneCollapsedFeedFilterBar("))
        #expect(iPadContentView.contains("text: $store.clientFilterQuery"))
        #expect(iPadContentView.contains("private func showsPhoneCollapsedFeedFilter(layout: MobileWorkspaceLayout) -> Bool"))
        ...
        #expect(iPadContentView.contains("phoneHasActiveFeedFilter || (isPhoneFeedAtContentStart == false && isPhoneCollapsedFeedFilterVisible)"))
        ...
        #expect(iPadContentView.contains("private struct PhoneCollapsedFeedFilterBar: View"))
        #expect(iPadContentView.contains("NativeInlineFilterField("))
        #expect(iPadContentView.contains("text: $text"))
        #expect(iPadContentView.contains("usesTransparentBackground: true"))
        #expect(iPadContentView.contains("Image(systemName: \"line.3.horizontal.decrease.circle\")") == false)
        #expect(iPadContentView.contains("private var phoneCollapsedFeedFilterLeadingPadding: CGFloat"))
        #expect(iPadContentView.contains("isPhoneFeedAtContentStart ? 28 : 80"))
        #expect(iPadContentView.contains("private var phoneCollapsedFeedFilterBottomPadding: CGFloat"))
        #expect(iPadContentView.contains("isPhoneFeedAtContentStart ? 22 : 0"))
        #expect(iPadContentView.contains("private var phoneCollapsedFeedFilterVerticalOffset: CGFloat"))
        #expect(iPadContentView.contains("isPhoneFeedAtContentStart ? 0 : 10"))
        #expect(iPadContentView.contains(".frame(height: 44)"))
        #expect(iPadContentView.contains(".padding(.leading, phoneCollapsedFeedFilterLeadingPadding)"))
        #expect(iPadContentView.contains(".offset(y: phoneCollapsedFeedFilterVerticalOffset)"))
        #expect(iPadContentView.contains(".frame(maxWidth: .infinity, alignment: .trailing)"))
        #expect(iPadContentView.contains(".glassEffect(.regular.interactive(), in: Capsule(style: .continuous))"))
        ...
        #expect(iPadContentView.contains(".accessibilityValue(resultText)"))
        ...
        #expect(tabBarBridge.contains("selectedItemFrame("))
