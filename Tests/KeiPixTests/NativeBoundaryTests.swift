...
struct NativeBoundaryTests {
    ...
    func compactSearchIsOptInInsteadOfPersistentEverywhere() throws {
        ...
        #expect(iPadContentView.contains("isPhoneFeedAtContentStart ? 14 : 94"))
        #expect(iPadContentView.contains("private var phoneCollapsedFeedFilterBottomPadding: CGFloat"))
        #expect(iPadContentView.contains("isPhoneFeedAtContentStart ? feedbackOverlayBottomPadding : 0"))
        #expect(iPadContentView.contains(".frame(height: 46)"))
