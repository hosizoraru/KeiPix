...
struct VisualQAEvidenceTests {
    ...
    func surfaceCoverage() {
        ...
        #expect(VisualQASurface(rawValue: "pixiv-activity") == .pixivActivity)
        ...
        #expect(VisualQASurface(rawValue: "work-subscriptions") == .workSubscriptions)
        ...
        #expect(VisualQASurface(rawValue: "gallery-selection-mode") == .gallerySelectionMode)
        ...
        #expect(VisualQASurface(rawValue: "novel-translation-smoke") == .novelTranslationSmoke)
        ...
        #expect(VisualQASurface(rawValue: "download-settings") == .downloadSettings)
        ...
        #expect(VisualQASurface(rawValue: "novel-bookmark-editor") == .novelBookmarkEditor)
        #expect(VisualQALaunchArgument.discoverDashboard.surface == .discoverDashboard)
        #expect(VisualQALaunchArgument.discoverDashboardCustomization.surface == .discoverDashboard)
        #expect(VisualQALaunchArgument.mangaWatchlist.surface == .mangaWatchlist)
        #expect(VisualQALaunchArgument.workSubscriptions.surface == .workSubscriptions)
        #expect(VisualQALaunchArgument.pixivIDOpen.surface == .pixivIDOpen)
        #expect(VisualQALaunchArgument.pixivActivity.surface == .pixivActivity)
        ...
        #expect(VisualQALaunchArgument.readingSettings.surface == .settingsWindow)
        #expect(VisualQALaunchArgument.downloadSettings.surface == .downloadSettings)
        ...
        #expect(VisualQALaunchArgument.downloadQueue.surface == .downloadQueue)
        ...
        #expect(VisualQALaunchArgument.novelBookmarkEditor.surface == .novelBookmarkEditor)
        ...
        #expect(VisualQALaunchArgument.novelTranslationSmoke.surface == .novelTranslationSmoke)
        #expect(VisualQALaunchArgument.gallerySelectionMode.surface == .gallerySelectionMode)
        ...
        #expect(VisualQALaunchArgument.gallerySelectionMode.galleryLayoutMode == .twoColumnMasonry)
        ...
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-pixiv-activity"]))
        ...
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-novel-bookmark-editor"]))
        ...
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-discover-dashboard-customization"]))
        ...
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-reading-settings"]))
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-download-settings"]))
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-sharing-templates"]))
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-download-queue"]))
        ...
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-novel-translation-smoke"]))
        #expect(VisualQALaunchArgument.isActive(in: ["KeiPix", "--visual-qa-gallery-selection-mode"]))
