...
struct DiscoveryDashboardTests {
    ...
    func dashboardLeadsWithHighlightsAndForYou() throws {
        ...
        #expect(dashboard.contains("DiscoveryDashboardPageMenu("))
        #expect(dashboard.contains("Toggle(L10n.showContentBadges, isOn: store.settings_showContentBadgesBinding)"))
        #expect(dashboard.contains("Toggle(L10n.hideR18GArtworks, isOn: store.settings_hideR18GBinding)"))
