...
case "$MODE" in
  run|--debug|debug|--logs|logs|--telemetry|telemetry|--verify|verify|--package|package|--visual-qa-discover-dashboard|visual-qa-discover-dashboard|--visual-qa-pixiv-link-drop|visual-qa-pixiv-link-drop|--visual-qa-pixiv-id-open|visual-qa-pixiv-id-open|--visual-qa-creator-profile|visual-qa-creator-profile|--visual-qa-feedback-sheet|visual-qa-feedback-sheet|--visual-qa-artwork-detail-social|visual-qa-artwork-detail-social|--visual-qa-bookmark-editor|visual-qa-bookmark-editor|--visual-qa-manga-watchlist|visual-qa-manga-watchlist|--visual-qa-series-sheet|visual-qa-series-sheet|--visual-qa-cached-feed|visual-qa-cached-feed|--visual-qa-search-workspace|visual-qa-search-workspace|--visual-qa-novel-feed|visual-qa-novel-feed|--visual-qa-ranking|visual-qa-ranking|--visual-qa-muted-content|visual-qa-muted-content|--visual-qa-about|visual-qa-about|--visual-qa-settings-window|visual-qa-settings-window|--visual-qa-runtime-readiness|visual-qa-runtime-readiness|--visual-qa-sharing-templates|visual-qa-sharing-templates|--visual-qa-ugoira-player|visual-qa-ugoira-player|--visual-qa-downloaded-reader|visual-qa-downloaded-reader|--visual-qa-gallery-auto|visual-qa-gallery-auto|--visual-qa-gallery-two-column|visual-qa-gallery-two-column|--visual-qa-gallery-three-column|visual-qa-gallery-three-column|--visual-qa-gallery-compact|visual-qa-gallery-compact)
    ;;
  *)
    echo "usage: $0 [run|--debug|--logs|--telemetry|--verify|--package|--visual-qa-discover-dashboard|--visual-qa-pixiv-link-drop|--visual-qa-pixiv-id-open|--visual-qa-creator-profile|--visual-qa-feedback-sheet|--visual-qa-artwork-detail-social|--visual-qa-bookmark-editor|--visual-qa-manga-watchlist|--visual-qa-series-sheet|--visual-qa-cached-feed|--visual-qa-search-workspace|--visual-qa-novel-feed|--visual-qa-ranking|--visual-qa-muted-content|--visual-qa-about|--visual-qa-settings-window|--visual-qa-runtime-readiness|--visual-qa-sharing-templates|--visual-qa-ugoira-player|--visual-qa-downloaded-reader|--visual-qa-gallery-auto|--visual-qa-gallery-two-column|--visual-qa-gallery-three-column|--visual-qa-gallery-compact]" >&2
    exit 2
    ;;
esac
