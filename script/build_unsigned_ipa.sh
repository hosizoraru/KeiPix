...
COMMON_XCODE_ARGS=(
  ...
  KEIPIX_BUILD_NUMBER_SOURCE="$KEIPIX_BUILD_NUMBER_SOURCE"
  KEIPIX_BUILD_ANCHOR_TAG="$KEIPIX_BUILD_ANCHOR_TAG"
  KEIPIX_BUILD_COMMIT_COUNT="$KEIPIX_BUILD_COMMIT_COUNT"
  KEIPIX_BUILD_BASE_NUMBER="$KEIPIX_BUILD_BASE_NUMBER"
  KEIPIX_BUILD_DISPLAY_NUMBER="$KEIPIX_BUILD_DISPLAY_NUMBER"
  KEIPIX_BUILD_IDENTITY="$KEIPIX_BUILD_IDENTITY"
  KEIPIX_GIT_COMMIT="$KEIPIX_GIT_COMMIT"
  KEIPIX_GIT_SHORT_COMMIT="$KEIPIX_GIT_SHORT_COMMIT"
  KEIPIX_GIT_DIRTY="$KEIPIX_GIT_DIRTY"
  KEIPIX_GIT_DESCRIBE="$KEIPIX_GIT_DESCRIBE"
)
