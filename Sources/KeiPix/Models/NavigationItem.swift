...
enum PixivRoute: String, CaseIterable, Identifiable, Codable {
    ...
    var title: String {
        ...
        case .pixivActivity: L10n.pixivActivity
        ...
        case .myPixivCollections: L10n.myPixivCollections
    ...
    var systemImage: String {
        ...
        case .pixivActivity: "bolt.horizontal.circle"
        ...
        case .myPixivCollections: "person.crop.rectangle.stack"
