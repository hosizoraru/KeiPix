...
| QA and diagnostics | 97% | Non-novel QA matrix exists, gallery/download/reader visual surfaces read stored screenshot evidence, and Runtime Readiness exposes account token refresh diagnostics. | Keep manifests and signed-in account-health evidence fresh after route/auth changes. |
