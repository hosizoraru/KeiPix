...
| Downloads | 99% | Strong queue, page-range multi-P downloads, staggered failed-item retry, local library, explicit download-to-bookmark automation, and local viewer resume. | Add visual QA screenshot evidence for local download flows. |
