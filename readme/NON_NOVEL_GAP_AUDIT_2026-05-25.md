...
| QA and diagnostics | 96% | Non-novel QA matrix exists and gallery/download/reader visual surfaces read stored screenshot evidence. | Keep manifests fresh after signed-in route changes. |
