...
| Downloads | Queue, concurrent tasks, naming templates, batch download, local library. | Queue, filters/search/sort, template placeholders, visible batch actions, local previews, Finder actions. | Add page-range batch downloads, retry-all-failed with backoff, and optional auto-bookmark-after-download parity. | P1 |
...
| Downloads | 90% | Strong queue and local library. | Add page-range batch and retry-all-failed. |
...
| 5 | Deepen reader/download parity | Add full-screen reader preset, page-range download, retry-all-failed with backoff, and optional auto-bookmark-after-download. | 50P+ manga can be read and downloaded by page range; failed downloads can recover in one action. |
