...
| Downloads | 98% | Strong queue, page-range multi-P downloads, staggered failed-item retry, local library, and explicit download-to-bookmark automation. | Add downloaded local viewer resume later. |
...
| 5 | Deepen reader/download parity | Add optional auto-bookmark-after-download and per-artwork reader resume. | Reader resume and auto-bookmark-after-download are done; next work is downloaded local viewer resume. |
...
Recommended next implementation wave: downloaded local viewer resume, then manga watchlist update badges.
